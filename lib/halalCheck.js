...
// Note: "beef bacon" / "turkey bacon" only clears the HARAM "bacon" (pork) flag —
// the "beef"/"turkey" term still correctly fires as mashbooh, since the
// zabiha-sourcing of that beef/turkey is still unverified.
const COMPOUND_SAFE_PHRASES = [
  { phrase: "root beer", suppressesTerm: "beer" },
  { phrase: "beef bacon", suppressesTerm: "bacon" },
  { phrase: "turkey bacon", suppressesTerm: "bacon" },
  { phrase: "chicken bacon", suppressesTerm: "bacon" },
];
